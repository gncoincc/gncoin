...
static const CRPCCommand vRPCCommands[] =
    {
        ...
        /* Gncoin features */
        {"gncoin", "masternode", &masternode, true, true, false},
        {"gncoin", "listmasternodes", &listmasternodes, true, true, false},
        {"gncoin", "getmasternodecount", &getmasternodecount, true, true, false},
        {"gncoin", "masternodeconnect", &masternodeconnect, true, true, false},
        {"gncoin", "masternodecurrent", &masternodecurrent, true, true, false},
        {"gncoin", "masternodedebug", &masternodedebug, true, true, false},
        {"gncoin", "startmasternode", &startmasternode, true, true, false},
        {"gncoin", "createmasternodekey", &createmasternodekey, true, true, false},
        {"gncoin", "getmasternodeoutputs", &getmasternodeoutputs, true, true, false},
        {"gncoin", "listmasternodeconf", &listmasternodeconf, true, true, false},
        {"gncoin", "getmasternodestatus", &getmasternodestatus, true, true, false},
        {"gncoin", "getmasternodewinners", &getmasternodewinners, true, true, false},
        {"gncoin", "getmasternodescores", &getmasternodescores, true, true, false},
        {"gncoin", "mnbudget", &mnbudget, true, true, false},
        {"gncoin", "preparebudget", &preparebudget, true, true, false},
        {"gncoin", "submitbudget", &submitbudget, true, true, false},
        {"gncoin", "mnbudgetvote", &mnbudgetvote, true, true, false},
        {"gncoin", "getbudgetvotes", &getbudgetvotes, true, true, false},
        {"gncoin", "getnextsuperblock", &getnextsuperblock, true, true, false},
        {"gncoin", "getbudgetprojection", &getbudgetprojection, true, true, false},
        {"gncoin", "getbudgetinfo", &getbudgetinfo, true, true, false},
        {"gncoin", "mnbudgetrawvote", &mnbudgetrawvote, true, true, false},
        {"gncoin", "mnfinalbudget", &mnfinalbudget, true, true, false},
        {"gncoin", "checkbudgets", &checkbudgets, true, true, false},
        {"gncoin", "mnsync", &mnsync, true, true, false},
        {"gncoin", "spork", &spork, true, true, false},
        {"gncoin", "getpoolinfo", &getpoolinfo, true, true, false},
#ifdef ENABLE_WALLET
        {"gncoin", "obfuscation", &obfuscation, false, false, true}, /* not threadSafe because of SendMoney */
...
void StartRPCThreads()
{
    ...
    if (((mapArgs["-rpcpassword"] == "") ||
        ...
        uiInterface.ThreadSafeMessageBox(strprintf(
                                             _("To use gncoind, or the -server option to gncoin-qt, you must set an rpcpassword in the configuration file:\n"
                                               "%s\n"
...
{
    return "> gncoin-cli " + methodname + " " + args + "\n";
}
...
std::string HelpExampleRpc(string methodname, string args)
{
    return "> curl --user myusername --data-binary '{\"jsonrpc\": \"1.0\", \"id\":\"curltest\", "
           "\"method\": \"" +
           methodname + "\", \"params\": [" + args + "] }' -H 'content-type: text/plain;' http://127.0.0.1:42923/\n";
}
