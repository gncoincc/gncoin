...
#   c) node1 mines 32 blocks, so now node 0 has 60001gncoin, node 1 has 4250gncoin, node2 has none.
#   d) node0 sends 601 gncoin to node2, in two transactions (301 gncoin, then 300 gncoin).
