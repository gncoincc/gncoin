...
This mechanism has been integrated into Bitcore-Node-GNC which allows for notification to be broadcast through Insight API in one of two ways:
* WebSocket: [https://github.com/GNC-Project/insight-api-gncoin#web-socket-api](https://github.com/GNC-Project/insight-api-gncoin#web-socket-api) 
* API: [https://github.com/GNC-Project/insight-api-gncoin#swifttx-transactions](https://github.com/GNC-Project/insight-api-gncoin#swifttx-transactions) 
...
By default, the GNC Core daemon will launch using the following constant:

```
static const int DEFAULT_SWIFTTX_DEPTH = 5;
```

This value can be overridden by passing the following argument to the GNC Core daemon:
