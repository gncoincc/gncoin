...
QString TransactionTableModel::formatTxType(const TransactionRecord* wtx) const
{
    ...
    case TransactionRecord::ZerocoinMint:
        return tr("Converted Gncoin to zGncoin");
    case TransactionRecord::ZerocoinSpend:
        return tr("Spent zGncoin");
    case TransactionRecord::RecvFromZerocoinSpend:
        return tr("Received Gncoin from zGncoin");
    case TransactionRecord::ZerocoinSpend_Change_zGncoin:
        return tr("Minted Change as zGncoin from zGncoin Spend");
    case TransactionRecord::ZerocoinSpend_FromMe:
        return tr("Converted zGncoin to Gncoin");
