...
In order to support loading of multiple wallets in gncoin-qt, a few changes in the UI architecture will be needed.
...
Only requiring some minor changes is gncoin.cpp.
...
Changes to gncoin.cpp
----------------------
gncoin.cpp is the entry point into gncoin-qt, and as such, will require some minor modifications to provide hooks for
