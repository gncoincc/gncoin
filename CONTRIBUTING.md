Contributing to GNC Core
============================

The GNC Core project operates an open contributor model where anyone is
...
The following applies to code changes to the GNC Core project, and is not to be
confused with overall GNC Network Protocol consensus changes.

Whether a pull request is merged into GNC Core rests with the project merge
...
Patches that change GNC consensus rules are considerably more involved than
...
Where a patch set proposes to change the GNC consensus, it must have been
...
The project leader is the release manager for each GNC Core release.
