...
static bool AppInitRawTx(int argc, char* argv[])
{
    ...
    if (argc < 2 || mapArgs.count("-?") || mapArgs.count("-help")) {
        ...
        std::string strUsage = _("Gncoin Core gncoin-tx utility version") + " " + FormatFullVersion() + "\n\n" +
                               _("Usage:") + "\n" +
                               "  gncoin-tx [options] <hex-tx> [commands]  " + _("Update hex-encoded gncoin transaction") + "\n" +
                               "  gncoin-tx [options] -create [commands]   " + _("Create hex-encoded gncoin transaction") + "\n" +
                               "\n";
...
static int CommandLineRawTx(int argc, char* argv[])
{
    ...
    try {
        ...
        if (!fCreateBlank) {
            ...
            // param: hex-encoded gncoin transaction
