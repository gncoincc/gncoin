                                                                            ...
                                                                            spinnerFrame(0)
{
    ...
    QString windowTitle = tr("GNC Core") + " - ";
#ifdef ENABLE_WALLET
...
void BitcoinGUI::createActions(const NetworkStyle* networkStyle)
{
    ...
    receiveCoinsAction->setStatusTip(tr("Request payments (generates QR codes and gncoin: URIs)"));
    ...
    privacyAction->setStatusTip(tr("Privacy Actions for zGNC"));
    ...
    aboutAction = new QAction(networkStyle->getAppIcon(), tr("&About GNC Core"), this);
    aboutAction->setStatusTip(tr("Show information about GNC Core"));
    ...
    openAction->setStatusTip(tr("Open a GNC: URI or payment request"));
    openBlockExplorerAction = new QAction(QIcon(":/icons/explorer"), tr("&Blockchain explorer"), this);
    openBlockExplorerAction->setStatusTip(tr("Block explorer window"));

    showHelpMessageAction = new QAction(QApplication::style()->standardIcon(QStyle::SP_MessageBoxInformation), tr("&Command-line options"), this);
    showHelpMessageAction->setMenuRole(QAction::NoRole);
    showHelpMessageAction->setStatusTip(tr("Show the GNC Core help message to get a list with possible GNC command-line options"));
...
void BitcoinGUI::createTrayIcon(const NetworkStyle* networkStyle)
{
    ...
    QString toolTip = tr("GNC Core client") + " " + networkStyle->getTitleAddText();
...
{
    QString strTitle = tr("GNC Core"); // default title
