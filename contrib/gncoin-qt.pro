...
RESOURCES += src/qt/gncoin.qrc src/qt/gncoin_locale.qrc

TRANSLATIONS += src/qt/locale/gncoin_bg.ts \
                src/qt/locale/gncoin_de.ts \
                src/qt/locale/gncoin_en.ts \
                src/qt/locale/gncoin_es.ts \
                src/qt/locale/gncoin_fi.ts \
                src/qt/locale/gncoin_fr.ts \
                src/qt/locale/gncoin_it.ts \
                src/qt/locale/gncoin_ja.ts \
                src/qt/locale/gncoin_pl.ts \
                src/qt/locale/gncoin_pt.ts \
                src/qt/locale/gncoin_ru.ts \
                src/qt/locale/gncoin_sk.ts \
                src/qt/locale/gncoin_sv.ts \
                src/qt/locale/gncoin_vi.ts \
                src/qt/locale/gncoin_zh_CN.ts \
                src/qt/locale/gncoin_zh_TW.ts
